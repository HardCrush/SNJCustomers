    ...
    void actionButtonOnClick(){
        ...
        if (isNetworkAvailable(LoginActivity.this)) {
            ...
            if (getIntent().getBooleanExtra("EXTRA", false)) {
                ...
                intent.putExtra("phonenumber", getString(R.string.mobile_prefix) + number);
...
//                Snackbar.make(findViewById(R.id.parent),,Snackbar.LENGTH_LONG).show();
    ...
    private void chekUser(String phonenumber) {
        if ((getString(R.string.mobile_prefix) + phonenumber).equals(getSharedPreferences("USER_CREDENTIALS", MODE_PRIVATE)
        ...
        FirebaseDatabase.getInstance().getReference("Customers").
                orderByChild("MOBILE").startAt(getString(R.string.mobile_prefix) + phonenumber).endAt("+91" + phonenumber + "\uf8ff").
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getChildrenCount()>=1){
                    ...
                    Intent intent = new Intent(LoginActivity.this, VerifyPhoneActivity.class);
                    intent.putExtra("phonenumber", getString(R.string.mobile_prefix) + phonenumber);
